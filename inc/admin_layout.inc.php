	...
	$("#enimg").click(function(){
		...
		<div class="inner-sidebar">
			...
			<div class="postbox">
				...
				<div class="inside">
				<p>
				<a href="http://wordpress.org/plugins/better-page-speed"  target = "_blank"><b>Plugin Homepage</b></a><br /><br />
				<b>Facebook</b> : <a href="http://wordpress.org/plugins/better-page-speed" target = "_blank">Developer\'s Page</a><br />
				<b>Twitter</b> : <a href="http://wordpress.org/plugins/better-page-speed"  target = "_blank">@BestPluginsss</a><br />
				</p>
